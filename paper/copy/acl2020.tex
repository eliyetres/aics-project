...
Project  \\
  ...
  \texttt{gusihaliel@student.g.,se} \\\And
  Second Author \\
...
Color is not forbidden, but authors should ensure that tables and 
s do not rely solely on color to convey critical distinctions.
A simple criterion:
